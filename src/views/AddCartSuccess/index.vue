  ...
  <div class="cart-complete-wrap">
    <div class="cart-complete">
      ...
      <div class="goods">
        <div class="left-good">
          <div class="left-pic">
            <img :src="successCartList.skuInfo.skuDefaultImg" />
          </div>
          <div class="right-info">
            <p class="title">
              {{ successCartList.skuInfo.skuName }}
            </p>
            <p class="attr">
              <span v-for="type in successCartList.ProductDetail" :key="type.id"
                >{{ type.saleAttrName }} :<span>{{
...
export default {
  ...
  computed: {
    ...mapState({
      successCartList: (state) => state.shopcart.successCartList,
    }),
  },
};
</script>
